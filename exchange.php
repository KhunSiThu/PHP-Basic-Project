    ...
    <form action="./exchange-process.php" method="post">
        ...
        <div class="grid grid-cols-2 gap-5">
            <div class="col-span-full">
                <label for="width" class="block text-sm font-medium mb-2 dark:text-white">From Currency Amount</label>
                <input type="number" name="amount" id="width" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
            </div>
        ...
        <button type="submit" class="mt-5 w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">
            Calculate
        </button>
    </form>
